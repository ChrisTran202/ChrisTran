...
export const About = () => {
  ...
  return (
    <section id="about" className="flex flex-col items-center justify-center pt-[5rem] h-[90vh]  animate-fade-up animate-duration-1000 animate-delay-[200ms] animate-ease-in-out animate-fill-both ">
      <div className="border-[#ff9d48] border-[.1rem] w-[80%] md:h-[75vh]  rounded-[5rem] ">
        <div className=' flex flex-col items-center pb-[2rem]'>
          ...
          <div className='h-[60vh]'>
            <h2 className=" text-white text-center text-[15px] p-5 md:pt-[2rem] md:w-[60vw] md:h-auto md:text-[20px] lg:text-[25px]">
            ...
            <h2 className="text-white text-[15px] p-5 md:w-[60vw] text-center md:text-[20px] lg:text-[25px] ">

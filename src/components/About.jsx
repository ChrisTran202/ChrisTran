        ...
        <div className=' flex flex-col items-center pb-[2rem] '>
          ...
          <div className='h-[60vh] md:h-[60vh] w-[50vw] flex flex-col items-center justify-center  '>
            <h2 className=" text-white text-center text-[14px] w-[70vw] p-5 md:pt-[2rem] md:w-auto h-[34vh] md:h-[25rem] md:text-[20px] lg:text-[25px]">
              I broke free from the grind of blue-collar jobs, diving headfirst into the realm of front-end web development. 
              ...
              There are so many things to learn that you will always end up going down the rabbit hole of so many different ways to do that one the thing.
            </h2>  

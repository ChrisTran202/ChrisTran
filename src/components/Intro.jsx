        ...
        <div className='font-bold flex flex-col items-center '>
          ...
          <div className='pt-[2rem] lg:pt-[5rem] flex-col items-center justify-center'>
            ...
            <div className='flex flex-row items-center justify-center'>
              ...
              >
                <FaLinkedin className='bg-[#ffa600] border-[#da28fd] hover:border-white hover:shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] border-[.2rem] rounded-md  w-[2rem] h-[2rem]  md:h-[3rem] md:w-[3rem] hover:scale-125 ease-in-out duration-200 animate-bounce  animate-duration-1000 '/>
              </a>
            </div>
          </div>

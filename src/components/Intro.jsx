...
function Intro() {
  ...
  return (
    ...
    <section className='flex flex-col gap-5 items-center h-[80vh] md:h-[85vh] justify-center mt-[5rem] '>
      ...
      {/* title */}
        <div className=' font-bold flex flex-col items-center  '>
          ...
          <h2 id="title"  className='text-[#ffffff]  text-[1.4rem] md:text-4xl  animate-fade-left animate-duration-700 animate-delay-[700ms] animate-ease-in animate-fill-both  '>
          ...
          <div className='pt-[2rem] lg:pt-[5rem] flex-col items-center justify-center '>
            ...
            {/* profile picture */}
                <img src={profileImg} className=' rounded-[20rem] w-[250px]  '/>

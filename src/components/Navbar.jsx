  ...
  {/* Big Screen Menu */}
      <nav className=' justify-end bg-gradient-to-r from-rose-400 to-orange-300 bg-clip-text text-transparent hidden w-[50vw] xl:w-[30vw] sm:flex justify-right  gap-[.8rem] md:gap-[2rem] font-semibold text-[1.2rem] '>
        ...
        <Link 
          to='/' 
          id='title' 
          className='hover:text-gray-100 hover:scale-125 ease-in-out duration-200 hover:shadow-xl active:border-solid active:bg-clip-text md:text-2xl '
        >
          Home
        </Link>
        ...
        <Link 
          to='about' 
          id='title' 
          className='hover:text-gray-100 hover:scale-125 ease-in-out duration-200 hover:shadow-xl md:text-2xl'
        >
          About
        </Link>
        ...
        <button 
          ...
          <nav className={showMenu ? 'font-bold fixed left-0 top-0 w-[60%] h-[100vh] rounded-r-[3rem]  ease-in-out duration-500 bg-[#000000ed] text-2xl  flex flex-col gap-4 items-center ' : 'fixed left-[-100%]'}>
            <Link 
              to='/' 
              id='title' 
              className='hover:text-white bg-gradient-to-r from-rose-400 to-orange-300 bg-clip-text text-transparent pt-10 p-4 hover: '>
              Home
            </Link>
            ...
            <Link 
              to='/about' 
              id='title' 
              className='hover:text-white bg-gradient-to-r from-rose-400 to-orange-300 bg-clip-text text-transparent p-4 md:text-3xl '>
              About
            </Link>

            <Link  
              to='/projects' 
              id='title' className='hover:text-white bg-gradient-to-r from-rose-400 to-orange-300 bg-clip-text text-transparent p-4 md:text-3xl '>
              Projects
            </Link>
          </nav>
      </nav>
